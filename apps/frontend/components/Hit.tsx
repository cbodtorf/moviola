...
import { Box, Badge, ButtonGroup, IconButton, Image, Stack, useDisclosure } from '@chakra-ui/react';
        ...
        <Box padding='12px' flex='1'>
          <ButtonGroup size='sm' isAttached variant='outline'>
            <IconButton
              ...
              onClick={onOpen}
            />
            <IconButton aria-label='Delete' icon={<DeleteIcon onClick={onAlertOpen} />} />
          </ButtonGroup>
        </Box>
      </Stack>
